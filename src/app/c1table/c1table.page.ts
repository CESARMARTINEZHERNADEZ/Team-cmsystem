...
//
  ...
  updateLendTotal() {
    ...
    this.selectedConsumablesLend.forEach(selected => {
        ...
        this.firebaseService.setCollectionWithId('lendFibers', lendId, newLend) 
            .then(() => {
              ...
              buttons: [
                { text: 'CANCEL', role: 'cancel' },
                {
                  ...
                  handler: (data) => {
                    ...
                    this.firebaseService.update(`lendFibers/${lend.Id}`, updatedLend)
                      .then(() => this.loadLend())
                    ...
                    const deleteAlert = await this.alertController.create({
                        ...
                        buttons: [
                            { text: 'CANCEL', role: 'cancel' },
                            {
                                text: 'DELETE',
                                handler: () => {
                                    this.firebaseService.deleteDocument('lendFibers', lend.Id)
                                        .then(() => {
                                            this.loadLend();
  ...
  updateScrapTotal() {
    ...
    this.selectedConsumablesScrap.forEach(selected => {
        ...
        this.firebaseService.setCollectionWithId('scrapfibers', scrapId, newScrap) 
            .then(() => {
...
async updateScrap(scrap: any) {
            ...
            buttons: [
              { text: 'CANCEL', role: 'cancel' },
              {
                ...
                handler: (data) => {
                  ...
                  this.firebaseService.update(`scrapfibers/${scrap.Id}`, updatedScrap)
                    .then(() => this.loadScrap())
  ...
  loadScrap() {
    this.firebaseService.getCollection('scrapfibers').subscribe((data: any[]) => {
                    ...
                    const deleteAlert = await this.alertController.create({
                        ...
                        buttons: [
                            { text: 'CANCEL', role: 'cancel' },
                            {
                                text: 'DELETE',
                                handler: () => {
                                    this.firebaseService.deleteDocument('scrapfibers', scrap.Id)
                                        .then(() => {
                                            this.loadScrap();

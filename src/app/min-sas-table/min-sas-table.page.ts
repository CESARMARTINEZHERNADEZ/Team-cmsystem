...
@Component({
  selector: 'app-min-sas-table',
  templateUrl: './min-sas-table.page.html',
  styleUrls: ['./min-sas-table.page.scss'],
})
export class MinSasTablePage implements OnInit {
              ...
              buttons: [
                { text: 'CANCEL', role: 'cancel' },
                {
                  ...
                  handler: async (reasonData) => {
                    ...
                    this.firebaseService.setCollectionWithId('MiniSAS', newId, newConsumable)
            ...
            const deleteAlert = await this.alertController.create({
              ...
              buttons: [
                { text: 'CANCEL', role: 'cancel' },
                {
                  text: 'DELETE',
                  handler: () => {
                    this.firebaseService.deleteDocument('MiniSAS', consumable.Id)
                      .then(() => this.loadConsumables())
  ...
  updateLendTotal() {
    ...
    this.selectedConsumablesLend.forEach(selected => {
        ...
        this.firebaseService.setCollectionWithId('lendMiniSas', lendId, newLend) 
            .then(() => {
              ...
              buttons: [
                { text: 'CANCEL', role: 'cancel' },
                {
                  ...
                  handler: (data) => {
                    ...
                    this.firebaseService.update(`lendMiniSas/${lend.Id}`, updatedLend)
                      .then(() => this.loadLend())
                    ...
                    const deleteAlert = await this.alertController.create({
                        ...
                        buttons: [
                            { text: 'CANCEL', role: 'cancel' },
                            {
                                text: 'DELETE',
                                handler: () => {
                                    this.firebaseService.deleteDocument('lendMiniSas', lend.Id)
                                        .then(() => {
                                            this.loadLend();
  ...
  updateScrapTotal() {
    ...
    this.selectedConsumablesScrap.forEach(selected => {
        ...
        this.firebaseService.setCollectionWithId('scrapMiniSas', scrapId, newScrap) 
            .then(() => {
...
async updateScrap(scrap: any) {
            ...
            buttons: [
              { text: 'CANCEL', role: 'cancel' },
              {
                ...
                handler: (data) => {
                  ...
                  this.firebaseService.update(`scrapMiniSas/${scrap.Id}`, updatedScrap)
                    .then(() => this.loadScrap())
  ...
  loadScrap() {
    this.firebaseService.getCollection('scrapMiniSas').subscribe((data: any[]) => {
                    ...
                    const deleteAlert = await this.alertController.create({
                        ...
                        buttons: [
                            { text: 'CANCEL', role: 'cancel' },
                            {
                                text: 'DELETE',
                                handler: () => {
                                    this.firebaseService.deleteDocument('scrapMiniSas', scrap.Id)
                                        .then(() => {
                                            this.loadScrap();
